...
<body class="hold-transition skin-blue fixed sidebar-mini" onload="setInterval('displayServerTime()', 1000);">
  ...
  <div class="wrapper">
    ...
    } elseif ($page == 'reqruitment_information') {
      include 'reqruitment_information/index.php';
    } elseif ($page == 'vacancy') {
      include 'vacancy/index.php';
    } elseif ($page == 'jenis_soal') {
      include 'jenis_soal/index.php';
    } elseif ($page == 'departement') {
      include 'departement/index.php';
    ...
    <footer class="main-footer">
      ...
      </script> IdeasTeam All rights reserved
    </footer>
