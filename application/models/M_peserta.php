...
class M_peserta extends CI_model
{
	...
	*/
	...
	{
		return $this->db->get('tbl_applicant');
	}

	public function cek_paserta($nim)
	{
		return $this->db->get_where('tbl_applicant', array('nim' => $nim));
	}

	public function paserta_id($id_peserta)
	{
		return $this->db->get_where('tbl_applicant', array('id_peserta' => $id_peserta));
	}
	...
	public function data_peserta($id_peserta)
	{
		$this->db->select('*');
		$this->db->from('tbl_applicant');
		$this->db->join('tbl_vacancy', 'tbl_vacancy.id_lab = tbl_applicant.id_lab', 'left');
		$this->db->where('tbl_applicant.id_peserta', $id_peserta);
		return $this->db->get();
	}
	...
	public function cetak_peserta($id_lab)
	{
		...
		$this->db->where('tbl_applicant.status_verifikasi', $status_verifikasi);
		$this->db->order_by('tbl_applicant.nim', 'ASC');
		return $this->db->get();
	}

	public function update_paserta($data, $id_peserta)
	{
