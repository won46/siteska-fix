            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td>
                      <?php 
                          echo "<a href='".base_url('vacancy/download/'.$key->lampiran)."'>
                    ...
                    <td>
                      ...
                      <a href="<?php echo base_url('vacancy/delete/'.$id_lab); ?>" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return confirm('Hapus Formasi <?php echo $key->nama_lab; ?> ?')">
