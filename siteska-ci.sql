...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2020 at 10:00 AM
...
(5, 15, '5,19,1,21,15,4,14,2,13,10,17,7,9,18,20,16,12,3,6,11,38,42,58,48,33,49,61,62,45,35,37,50,23,40,32,31,39,36,60,34,41,59,43,44,22,71,70,53,78,63,76,64,47,57,67,54,52,66,79,55,56,75,73,81,46,69,8,74,83,65,68,80,77,72,51', '5:B:Y:S,19:B:Y:S,1:B:Y:B,21:C:Y:S,15:B:Y:S,4:C:Y:S,14:C:Y:S,2:B:Y:S,13:D:Y:S,10:B:Y:S,17:A:Y:B,7:C:Y:B,9:E:Y:S,18:B:Y:S,20:C:Y:S,16:X:N:S,12:X:N:S,3:X:N:S,6:X:N:S,11:X:N:S,38:X:N:S,42:X:N:S,58:X:N:S,48:X:N:S,33:X:N:S,49:X:N:S,61:X:N:S,62:X:N:S,45:X:N:S,35:X:N:S,37:X:N:S,50:X:N:S,23:X:N:S,40:X:N:S,32:X:N:S,31:X:N:S,39:X:N:S,36:X:N:S,60:X:N:S,34:X:N:S,41:X:N:S,59:X:N:S,43:X:N:S,44:X:N:S,22:X:N:S,71:X:N:S,70:X:N:S,53:X:N:S,78:X:N:S,63:X:N:S,76:X:N:S,64:X:N:S,47:X:N:S,57:X:N:S,67:X:N:S,54:X:N:S,52:X:N:S,66:X:N:S,79:X:N:S,55:X:N:S,56:X:N:S,75:X:N:S,73:X:N:S,81:X:N:S,46:X:N:S,69:X:N:S,8:X:N:S,74:X:N:S,83:X:N:S,65:X:N:S,68:X:N:S,80:X:N:S,77:X:N:S,72:X:N:S,51:X:N:S', '2020-04-27 11:57:51', '2020-04-27 13:27:51', 'Selesai');
...
(1, 'Seleksi Penerimaan Asisten Laboratorium Komputer', '2018-11-22', '2020-05-15', '2020-04-30', '2020-05-02', 90, 'Alur_Pendaftaran.jpg');
...
INSERT INTO `tbl_vacancy` (`id_lab`, `batch`, `nama_lab`, `jumlah_formasi`, `jumlah_peserta`, `jumlah_lulus_adm`, `lampiran`) VALUES
(9, '', 'Accounting', 2, 0, 0, 'Pertemuan_1_PAI1.pdf');
